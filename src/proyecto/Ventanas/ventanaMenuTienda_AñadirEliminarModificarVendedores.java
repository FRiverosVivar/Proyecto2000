 ...
 * @author Estudiante_2
 */
public class ventanaMenuTienda_AñadirEliminarModificarVendedores extends javax.swing.JFrame {

    /**
     * Creates new form ventanaMenuTienda_AñadirEliminarModificarVendedores
     */
    Empresa best;
    Tienda tienda;
    public ventanaMenuTienda_AñadirEliminarModificarVendedores(Empresa bestEmpresa,Tienda tienda1) {
        initComponents();
        tienda = tienda1;
        best = bestEmpresa;
    ...
    private void mnAddGer_jB_modificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnAddGer_jB_modificarActionPerformed
        ...
        if(best.modificarVendedor(nombre, rut, sueldo,rutnuevo,tienda.getID()) == -1){
            JOptionPane.showMessageDialog(null,"ya existe un vendedor con ese rut.");
            return;
        }
